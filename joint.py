...
model_file = f'models/model_joint_{option}_{thres}_{tid}.h5'
out_file = f'stats/tune_joint_{option}_{thres}_{tid}.pckl'
preds_file = f'preds/preds_joint_{option}_{thres}_{tid}.txt'
