...
tid = sys.argv[2]
print("option: Seq, threshold: ", thres)

model_file = f'models/model_seq_{thres}_{tid}.h5'
out_file = f'stats/tune_seq_{thres}_{tid}.pckl'
preds_file = f'preds/preds_seq_{thres}_{tid}.txt'
